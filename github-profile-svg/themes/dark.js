/**
 * Dark theme SVG template
 * @param {object} data User data
 * @param {string} title Optional title
 * @param {string} rank Calculated rank
 * @returns {string} SVG string
 */
function renderDarkTheme(data, title, rank) {
  ...
  return `
    <svg width="450" height="165" viewBox="0 0 450 165" fill="none" xmlns="http://www.w3.org/2000/svg">
      <style>
        ...
        .stat { font: 400 14px 'Segoe UI', Ubuntu, Sans-Serif; fill: #c9d1d9; animation: fadeIn 1s ease-in-out; }
        .label { font: 600 14px 'Segoe UI', Ubuntu, Sans-Serif; fill: #f0f6fc; animation: fadeIn 1s ease-in-out; }
        .rank-text { font: 800 48px 'Segoe UI', Ubuntu, Sans-Serif; fill: #58a6ff; animation: scaleIn 0.8s ease-in-out; }
        .rank-label { font: 600 12px 'Segoe UI', Ubuntu, Sans-Serif; fill: #8b949e; }
      ...
      <rect x="0.5" y="0.5" width="449" height="164" rx="10" fill="#0d1117" stroke="#30363d"/>
      ...
      <g transform="translate(350, 85)">
        <circle cx="0" cy="0" r="40" stroke="#30363d" stroke-width="2" fill="none" opacity="0.5"/>
...
module.exports = renderDarkTheme;
